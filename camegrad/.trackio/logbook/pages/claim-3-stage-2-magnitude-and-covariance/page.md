# Claim 3: Stage 2 magnitude and covariance


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_fb71028e7081", "created_at": "2026-07-29T18:36:44+00:00", "title": "Claim 3: Stage 2 magnitude and covariance"}
-->
**Verdict - PARTIALLY VERIFIED WITH EPSILON QUALIFICATION.**

Conditionally scaling seeded samples by `kappa=1.5` changes covariance trace
by `2.2500000000000004`, matching `kappa^2 =
2.25`. For a small nonzero direction and the
declared epsilon denominator, however, the target norm is
`7.5` and the observed norm is
`6.25`, a
`16.67%` shortfall.
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_d4208260b8d0", "created_at": "2026-07-29T18:36:44+00:00", "title": "C3 machine-readable evidence", "language": "python"}
-->
...
{
  "evidence": {
    "covariance_trace_after": 11.266907000882325,
    "covariance_trace_before": 5.007514222614366,
    "declared_trace_ratio": 2.25,
    "epsilon": 1e-08,
    "kappa": 1.5,
    "observed_norm": 6.25,
    "observed_trace_ratio": 2.2500000000000004,
    "paper_anchor_present": true,
    "relative_target_shortfall": 0.16666666666666666,
    "target_norm": 7.5
  },
  "id": "C3",
  "score": 1,
