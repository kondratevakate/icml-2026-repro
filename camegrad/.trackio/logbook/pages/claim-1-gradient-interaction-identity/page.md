# Claim 1: gradient interaction identity


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_4c86e2f180bb", "created_at": "2026-07-29T18:36:44+00:00", "title": "Claim 1: gradient interaction identity"}
-->
**Verdict - VERIFIED FOR THE EXACT TWO-TASK IDENTITY.**

Across 1000 seeded 17-dimensional trials, the maximum
absolute identity error is `8.527e-14`. Reversing
the interaction sign fails by as much as
`185.253`. Exact opposing gradients carry
individual energy `28.0` but joint
energy `0.0`.
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_1755bcbe67f0", "created_at": "2026-07-29T18:36:44+00:00", "title": "C1 machine-readable evidence", "language": "python"}
-->
...
{
  "evidence": {
    "identity_max_abs_error": 8.526512829121202e-14,
    "opposing_individual_energy": 28.0,
    "opposing_joint_energy": 0.0,
    "paper_anchor_present": true,
    "random_trials": 1000,
    "sign_mutation_max_abs_error": 185.25304975804465
  },
  "id": "C1",
  "score": 2,
  "verdict": "VERIFIED_FOR_EXACT_TWO_TASK_IDENTITY"
