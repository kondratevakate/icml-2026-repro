# Claim 2: Stage 1 Pareto guarantee


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_2153e40c3de0", "created_at": "2026-07-29T18:36:44+00:00", "title": "Claim 2: Stage 1 Pareto guarantee"}
-->
**Verdict - FALSIFIED AS AN UNCONDITIONAL GUARANTEE.**

For gradients `[1.0, -10.0]`, `mu=-4.5` and
`rho=0.5`, the trust region is `[-6.75, -2.25]`.
Both the exact primal and declared dual recover
`u*=-2.25`. Its task inner products are
`[-2.25, 22.5]`, so the worst value is
`-2.25` rather than non-negative.
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_9363ed700a12", "created_at": "2026-07-29T18:36:44+00:00", "title": "C2 machine-readable evidence", "language": "python"}
-->
...
````output
{
  "evidence": {
    ...
    "trust_region_residual": 0.0,
    "worst_inner_product": -2.25
  },
  "id": "C2",
  "score": 2,
  "verdict": "FALSIFIED_AS_UNCONDITIONAL_GUARANTEE"
