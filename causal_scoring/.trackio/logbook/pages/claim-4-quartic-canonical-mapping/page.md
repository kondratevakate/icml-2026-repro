# Claim 4: quartic canonical mapping


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_2d3eb483d52f", "created_at": "2026-07-29T19:11:25+00:00", "title": "Claim 4: quartic canonical mapping"}
-->
**Verdict - PARTIALLY VERIFIED; ASYMPTOTIC NO-VANISH INTERPRETATION FALSIFIED.**
...
`4.088e-12` over
`701` logits. The mapping is strictly monotone and
symmetric.
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_7109bb8859b8", "created_at": "2026-07-29T19:11:25+00:00", "title": "C4 machine-readable evidence", "language": "python"}
-->
...
{
  "evidence": {
    "canonical_gradient_abs_at_z_1e6_y1": 0.001000998994992841,
    "integrated_link_derivative_residual": "0",
    "logit_grid_size": 701,
    "max_roundtrip_relative_error": 3.0061040949707906e-12,
    "max_symmetry_error": 3.552713678800501e-15,
    "minimum_largest_root": 4.000000000000003,
    "mismatched_sigmoid_max_abs_gradient": 571969715.3685957,
    "paper_anchors_present": true,
    "quartic_max_relative_residual": 1.2592010767420447e-12,
    "quartic_root_vs_inverse_link_max_abs_error": 4.087952198972289e-12,
    "quartic_symbolic_residual": "0",
    "real_root_count_range": [
      2,
      4
    ],
