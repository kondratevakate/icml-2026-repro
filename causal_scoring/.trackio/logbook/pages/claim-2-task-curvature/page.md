# Claim 2: task curvature


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_42e5cfb4bf25", "created_at": "2026-07-29T19:11:25+00:00", "title": "Claim 2: task curvature"}
-->
**Verdict - VERIFIED.**

SymPy simplifies the difference between the task-divergence Hessian and the
declared curvature to `0`. A
`998`-point, 60-digit boundary-aware grid has maximum
relative error `3.150e-43`. Changing a cubic
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_4295722a5d83", "created_at": "2026-07-29T19:11:25+00:00", "title": "C2 machine-readable evidence", "language": "python"}
-->
...
````output
{
  "evidence": {
    "grid_size": 998,
    "max_relative_error": 3.150197414103077e-43,
    "mutation_max_relative_error": 0.999998000002,
