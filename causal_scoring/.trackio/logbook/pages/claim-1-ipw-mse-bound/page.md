# Claim 1: IPW MSE bound


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_c70bf40c72d9", "created_at": "2026-07-29T19:11:25+00:00", "title": "Claim 1: IPW MSE bound"}
-->
**Verdict - PARTIALLY VERIFIED, CONDITIONAL ON FIXED PROPENSITY.**

The theorem-specific pointwise bias inequality holds in 5,000 deterministic
trials; its maximum residual is
`-0.342828`. A separate sanity
...
`0.078125` and mean-variance residual
`0.0390625` relative to `Var(Z)/N`. The proof is valid
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_bc103fff9216", "created_at": "2026-07-29T19:11:25+00:00", "title": "C1 machine-readable evidence", "language": "python"}
-->
...
{
  "evidence": {
    "actual_mean_variance": 0.0859375,
    "conditional_proof_max_bias_residual": -0.34282764925261344,
    "crossfit_contribution_covariance": 0.078125,
    "exact_crossfit_states": 4,
    "generic_sum_variance_inequality_max_residual": -1.380299648132477,
    "iid_formula_residual": 0.0390625,
    "iid_variance_formula": 0.046875,
    "paper_anchors_present": true,
    "weakened_constant_mutation_violations": 794
  },
  "id": "C1",
  "score": 1,
  "verdict": "PARTIALLY_VERIFIED_CONDITIONAL_ON_FIXED_PROPENSITY"
