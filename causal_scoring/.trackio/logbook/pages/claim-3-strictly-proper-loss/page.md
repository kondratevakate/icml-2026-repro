# Claim 3: strictly proper loss


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_54903abb1e39", "created_at": "2026-07-29T19:11:25+00:00", "title": "Claim 3: strictly proper loss"}
-->
**Verdict - VERIFIED.**

Both proper-loss differential residuals simplify exactly to zero. The declared
weight is positive and equals `48.0`
at its symmetry point. Across `99` truths and
`3993` candidate predictions, maximum argmin
error is `1.110e-16`. Swapping label-specific
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_f866f60bdabe", "created_at": "2026-07-29T19:11:25+00:00", "title": "C3 machine-readable evidence", "language": "python"}
-->
...
{
  "evidence": {
    "label_swap_mutation_min_mean_argmin_error": 0.49494949494949486,
    "loss0_differential_residual": "0",
    "loss1_differential_residual": "0",
    "max_argmin_abs_error": 1.1102230246251565e-16,
    "minimum_declared_weight_at_half": 48.0,
    "paper_anchor_present": true,
    "prediction_grid_size": 3993,
    "truth_grid_size": 99
  },
  "id": "C3",
  "score": 2,
