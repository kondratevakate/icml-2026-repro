# Claim 3: SP-Bench construction


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_2f8fb8e59481", "created_at": "2026-07-29T17:06:36+00:00", "title": "Claim 3: SP-Bench construction"}
-->
**Verdict - VERIFIED.**

An independent JSONL parser finds `102` records,
`102` unique IDs and
`102` unique normalized queries. It
recomputes `18` categories and
`8` stages.

Tier counts are `{"advanced": 21, "basic": 40, "challenging": 13, "intermediate": 28}` and
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_0ad1ff0e0b9b", "created_at": "2026-07-29T17:06:36+00:00", "title": "C3 verdict record", "language": "python"}
-->
