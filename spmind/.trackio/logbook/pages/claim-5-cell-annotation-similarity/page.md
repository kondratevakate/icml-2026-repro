# Claim 5: cell-annotation similarity


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_cb4cd041f195", "created_at": "2026-07-29T17:06:36+00:00", "title": "Claim 5: cell-annotation similarity"}
-->
**Verdict - INCONCLUSIVE, MISSING PREDICTIONS.**

Four ground-truth files pass structural schema checks, covering
`2,013,525` rows. Original agent predictions are absent, so
...
`1,503,420` rows with repeated `cellLabel` values. These are
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_479f8ed64614", "created_at": "2026-07-29T17:06:36+00:00", "title": "C5 verdict record", "language": "python"}
-->
...
````output
{
  "id": "C5",
  "score": 0,
  "title": "Cell-annotation GHK similarity",
  "verdict": "INCONCLUSIVE_MISSING_PREDICTIONS"
}
````
