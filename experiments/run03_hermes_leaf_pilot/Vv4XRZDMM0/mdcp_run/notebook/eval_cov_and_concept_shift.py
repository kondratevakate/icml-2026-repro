...
SCRIPT_TAG = 'evaluation_cov_and_concept_shift_rand_avg'
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='MDCP evaluation under covariate + concept shift (x_and_y_shift).',
    )
    parser.add_argument(
        '--num-trials',
        type=int,
...
COV_AND_CONCEPT_EVAL_FOLDER = eval_out_relative('cov_and_concept_shift')  # noqa: F405
COV_AND_CONCEPT_EVAL_LAMBDA_FOLDER = COV_AND_CONCEPT_EVAL_FOLDER / 'lambda'


def ensure_output_dirs() -> Dict[str, Path]:
    directories = {
        'base': ensure_project_dir(COV_AND_CONCEPT_EVAL_FOLDER),  # noqa: F405
        'classification': ensure_project_dir(COV_AND_CONCEPT_EVAL_FOLDER / 'classification'),  # noqa: F405
        'regression': ensure_project_dir(COV_AND_CONCEPT_EVAL_FOLDER / 'regression'),  # noqa: F405
        'lambda': ensure_project_dir(COV_AND_CONCEPT_EVAL_LAMBDA_FOLDER),
        'summaries': ensure_project_dir(COV_AND_CONCEPT_EVAL_FOLDER / 'summaries'),  # noqa: F405
    }
    return directories
