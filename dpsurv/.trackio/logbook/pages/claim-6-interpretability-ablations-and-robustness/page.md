# Claim 6: interpretability, ablations, and robustness


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_03daf81c3637", "created_at": "2026-07-30T08:55:40+00:00", "title": "Claim 6: interpretability, ablations, and robustness"}
-->
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_f2a61f6b7b77", "created_at": "2026-07-30T08:55:40+00:00", "title": "Claim 6: interpretability, ablations, and robustness evidence", "language": "python"}
-->
...
{
  "visualization": {
    "get_panther_encoder_definition_count": 2,
    "effective_entrypoint_error": "NameError: name 'create_embedding_model' is not defined",
    "interpretation": "The second get_panther_encoder definition shadows the first and calls create_embedding_model, which is neither defined nor imported in the release."
  },
  "release": {
    "python_files": 30,
    "split_csv_files": 50,
