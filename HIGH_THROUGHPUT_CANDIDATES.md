...
| 5 | PyHealth 2.0 (`gMLVFN9hl8`) | 4-6 | 3-5 h | 0.8-2.0 | Existing local setup and MIMIC-III demo give a bounded CPU feasibility probe for catalog coverage and the seven-line path. | Do not count it as 6-point work until the local end-to-end route completes and the third claim has judge-grade evidence. |
