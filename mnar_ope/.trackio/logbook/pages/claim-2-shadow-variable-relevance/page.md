# Claim 2: shadow-variable relevance


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_14a85a84efed", "created_at": "2026-07-29T15:03:33+00:00", "title": "Claim 2: shadow-variable relevance"}
-->
**Anchored claim (verbatim).** "Assumption 3.2 (relevance condition) requires that the next state S_{t+1} is not conditionally independent of the reward R_t given S_t, A_t, O_t=1, formalizing the use of future states as shadow variables."
...
An independent vectorized implementation generated 60,000
one-step observations; 52,580 remained after conditioning
...
`r=0.2528` with
`p=0`. Adding next state reduced conditional
MSE from `0.017055` to
`0.015965`.
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_b76a0f3d2a3a", "created_at": "2026-07-29T15:03:34+00:00", "title": "C2 machine-readable evidence", "language": "python"}
-->
...
````output
{
  "checks": {
    ...
    "next_state_reduces_conditional_mse": true,
    "observed_subset_is_nonempty": true,
    "residual_association_is_material": true,
    "residual_association_is_significant": true,
    "reward_has_nonzero_next_state_weights": true,
    "reward_uses_next_state": true,
    "source_has_exact_relevance_condition": true
  },
  "diagnostic": {
    "base_mse": 0.0170553900876781,
    "checks": {
      "next_state_reduces_conditional_mse": true,
      "observed_subset_is_nonempty": true,
      "residual_association_is_material": true,
    ...
    "n_observed": 52580,
    "n_total": 60000,
    "relative_mse": 0.9360410787935518,
    "residual_pearson_p": 0.0,
    "residual_pearson_r": 0.2528497630908562,
    "with_next_state_mse": 0.01596454573691506
  },
  "scope": "Exact semantic claim plus an independent observed-subset diagnostic on the official data-generating process.",
  "verdict": "VERIFIED"
}
````
