# Claim 5: no future dependence


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_97e4bef00162", "created_at": "2026-07-29T15:03:34+00:00", "title": "Claim 5: no future dependence"}
-->
**Anchored claim (verbatim).** "Assumption 2.1 (no future dependence) posits that the current missingness indicator O_t is independent of future states and rewards given the current state, action, and reward, distinguishing the setting from standard missing-at-random assumptions."
...
60,000 independent observations. Adding the two next-state
coordinates after current state, action, and reward gave likelihood-ratio
`p=0.1468` and per-sample NLL improvement
`3.2e-05`. The future terms therefore provide no
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_f12a557dda56", "created_at": "2026-07-29T15:03:34+00:00", "title": "C5 machine-readable evidence", "language": "python"}
-->
...
{
  "checks": {
    "base_coefficients_match_generator": true,
    "future_terms_are_not_jointly_significant": true,
    "future_terms_do_not_materially_improve_fit": true,
    "missingness_draw_uses_only_probability": true,
    "missingness_logit_uses_current_action": true,
    "missingness_logit_uses_current_reward": true,
    "missingness_logit_uses_current_state": true,
    "reward_has_nonzero_next_state_weights": true,
    "reward_uses_next_state": true,
    "source_has_exact_no_future_condition": true
  },
  "diagnostic": {
    "base_coefficients": [
      1.0911724948293937,
    ...
    "extended_future_coefficients": [
      0.20398936325778633,
      -0.14976792838408173
    ],
    "likelihood_ratio": 3.838022440773784,
    "likelihood_ratio_p": 0.14675199579699427,
    "n": 60000,
    "nll_base": 20121.81939556638,
    "nll_extended": 20119.900384345994,
    "per_sample_nll_gain": 3.198352033978153e-05
  },
  "scope": "Exact semantic claim plus structural and numerical checks of the official missingness mechanism.",
  "verdict": "VERIFIED"
}
````
